...
If the install script exits with a download error or 404, check the [Releases page](https://github.com/spboyer/waza/releases/latest) to confirm a binary for your platform is available. You can also install manually:

```bash
# Example: macOS ARM64 (Apple Silicon) — replace <version> with the latest tag (e.g. v0.9.0)
curl -fSL -o waza https://github.com/spboyer/waza/releases/download/<version>/waza-darwin-arm64
chmod +x waza
