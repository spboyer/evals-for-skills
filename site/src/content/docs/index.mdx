...
<CardGrid stagger>
	...
	<Card title="Validate Quality" icon="approve">
		Use 8 built-in grader types to validate task completion, behavior, and quality metrics.
	</Card>
